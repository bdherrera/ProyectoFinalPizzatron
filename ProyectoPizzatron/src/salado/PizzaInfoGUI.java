...
public class PizzaInfoGUI {
    ...
    private void asignarNombresImagenes() {
        ...
        nombresImagenes.put(8, "Crust");
        nombresImagenes.put(12, "SalsadePizza");
        nombresImagenes.put(13, "SalsaPicante");
        nombresImagenes.put(14, "KESO");
        nombresImagenes.put(15, "quesoenpizza");
        nombresImagenes.put(16, "ALGAS");
        nombresImagenes.put(17, "ALGITA");
        nombresImagenes.put(18, "peces");
        nombresImagenes.put(19, "Fish1");
        nombresImagenes.put(20, "Calamares");
        nombresImagenes.put(21, "Squid2");
        nombresImagenes.put(22, "CAMARONES");
        nombresImagenes.put(23, "sHRIMP");
    }
